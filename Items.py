...
itemList: typing.List[ItemData] = [
    ...
    # ItemData(77780045, "Dragon Mirror Piece", ItemClassification.useful),
    # ItemData(77780046, "Chimera Mirror Piece", ItemClassification.useful),
    # ItemData(77780047, "Yeti Mirror Piece", ItemClassification.useful),
    # ItemData(77780048, "Plague Fiend Mirror Piece", ItemClassification.useful),
    ItemData(77780045, "Ice Axe of Untar", ItemClassification.useful),
    ItemData(77780046, "Flame of Tarkana", ItemClassification.useful),
    ItemData(77780047, "Scimitar of Decapitation", ItemClassification.useful),
    ItemData(77780048, "Marker's Javelin", ItemClassification.useful),
    ItemData(77780049, "Soul Savior", ItemClassification.useful),
    ItemData(77780050, "Gold", ItemClassification.filler),
]
